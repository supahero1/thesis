...
layout(constant_id = 0) const float ssao_blur_radius = 6.0;
layout(constant_id = 1) const float ssao_blur_falloff = 4.0;
layout(constant_id = 2) const float ssao_blur_depth_tolerance = 3.0;
